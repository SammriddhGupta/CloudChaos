...
from code.preprocessing.preprocessing_handler import (
    DataPreprocessingAPI,
    lambda_handler,
)


class TestDataPreprocessingAPI(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_s3.get_object.return_value = {
            "Body": MagicMock(
                read=MagicMock(
                    return_value=b'{"events": [{"timestamp": "2022-01-01", "close": 100}]}'
                )
            )
        }
    ...
    def test_lambda_handler(self):
        ...
        self.assertEqual(
            json.loads(response["body"]), "Data preprocessing completed successfully!"
        )
    ...
    def test_preprocess_data(self):
        ...
        expected_filename = "P1-AAPL-2017-01-01-2017-04-30.json"
    ...
    def test_preprocess_data_failure(self):
        ...
        with self.assertRaises(FileNotFoundError):
            self.api.preprocess_data("AAPL", "2022-01-01", "2022-04-30")
