...
from code.preprocessing_final.preprocessing_final_handler import (
    DataPreprocessingAPI,
    lambda_handler,
)


class TestDataPreprocessingFinalAPI(unittest.TestCase):
    def setUp(self):
    ...
    def test_lambda_handler(self):
        ...
        self.assertEqual(
            ...
            "Data preprocessing final completed successfully!",
        )
    ...
    def test_preprocess_data(self):
        ...
        expected_filename = "FP-AAPL-2017-01-01-2017-04-30.json"
